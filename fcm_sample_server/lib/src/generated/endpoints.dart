...
import '../../endpoints/notification_endpoint.dart' as _i2;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      'notifications': _i2.NotificationsEndpoint()
        ..initialize(
          server,
          'notifications',
          null,
    ...
    connectors['notifications'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'sendToDevice': _i1.MethodConnector(
          name: 'sendToDevice',
          params: {
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['notifications'] as _i2.NotificationsEndpoint)
                  .sendToDevice(
            session,
            params['token'],
            params['title'],
